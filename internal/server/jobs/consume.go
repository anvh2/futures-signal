...
import (
	...
	"github.com/anvh2/futures-signal/internal/cache/errors"
...
func (s *Jobs) processCandlesConsumption(ctx context.Context, pair map[string]string) (done chan struct{}, stop chan struct{}) {
...
func (s *Jobs) handleCandlesConsumption(event *futures.WsKlineEvent) {
...
func (s *Jobs) handleConsumeError(err error) {
