...
func (s *Server) processOrderConsumption(ctx context.Context) error {
	...
	fmt.Println("[OrderConsumption] start consume data from websocket")
...
func (s *Server) handleOrderConsumption(ctx context.Context, event *futures.WsUserDataEvent) {
